"""
озьмите код из прошлой задачи "Управление информацией о сотрудниках и их возрасте".
...
именем "Ivan", отчеством "Ivanovich" и убедитесь, что метод full_name() возвращает правильное полное
имя в формате "Ivanov Ivan Ivanovich".
...
class TestEmployee(unittest.TestCase):
    def test_employee_full_name(self):
        ...
        self.assertEqual(c1.full_name(), "Ivanov Ivan Ivanovich")

    def test_employee_birthday(self):
        c1 = Employee("Ivanov", "Ivan", "Ivanovich", 30, "", 0)
        c1.birthday()
        self.assertEqual(c1.get_age(), 31)
    ...
    def test_employee_str(self):
        ...
        self.assertEqual(c3.__str__(), "Ivanov Ivan Ivanovich (Manager)")

    def test_employee_last_name_title(self):
        c3 = Employee("ivanov", "ivan", "ivanovich", 30, "manager", 50000)
        self.assertEqual(c3.last_name, "Ivanov")
